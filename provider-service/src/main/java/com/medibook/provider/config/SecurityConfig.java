...
import com.medibook.provider.security.AuthTokenAuthenticationFilter;
import com.medibook.provider.security.InternalServiceAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/api/v1/providers/internal/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/providers/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
