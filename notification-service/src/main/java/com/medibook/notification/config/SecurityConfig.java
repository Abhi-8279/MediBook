...
import com.medibook.notification.security.AuthTokenAuthenticationFilter;
import com.medibook.notification.security.InternalServiceAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/api/v1/notifications/internal/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
