...
import com.medibook.payment.security.AuthTokenAuthenticationFilter;
import com.medibook.payment.security.InternalServiceAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/api/v1/payments/internal/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
